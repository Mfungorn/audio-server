...
class AlbumEntityResolver @Autowired constructor(
    ...
    override fun resolveId(id: IdKey): Any? {
        ...
        if (resolved == null) {
            resolved = _tryToLoadFromSource(id).orElseThrow { ResourceNotFoundException("Album", "id", id.key as Long) }
    ...
    private fun _tryToLoadFromSource(idKey: IdKey): Optional<Album> {
