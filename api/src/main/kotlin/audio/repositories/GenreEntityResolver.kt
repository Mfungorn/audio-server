...
class GenreEntityResolver @Autowired constructor(
    ...
    override fun resolveId(id: IdKey): Any? {
        ...
        if (resolved == null) {
            resolved = tryToLoadFromSource(id).orElseThrow { ResourceNotFoundException("Genre", "id", id.key as Long) }
    ...
    private fun tryToLoadFromSource(idKey: IdKey): Optional<Genre> {
